...
2. ~~Prettier 一括適用~~ → **見送りに変更**: コードベースは既に4スペース・シングルクォートで
   一貫しており、全面再フォーマットは git blame を汚す割に得るものが少ないため。
   一貫性の担保は ESLint（エラー・警告ゼロ運用）で行う
...
- [x] フェーズ0: 安全網（2026-06-12 完了, PR #25）
- [x] フェーズ1: 死蔵ファイル一掃（2026-06-12 完了, PR #26）
- [x] フェーズ2: テスト基盤（2026-06-12 完了, PR #27）
- [x] フェーズ3: ESモジュール化（2026-06-12 完了）
- [x] フェーズ4: 巨大ファイル分割（2026-06-12 完了）
- [x] フェーズ5: 仕上げ（2026-06-12 完了）
